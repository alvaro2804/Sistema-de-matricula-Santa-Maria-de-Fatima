	...
	<div class="header-right">
		...
		<ul class="notifications">
			...
			<?php
			 ...
			 $this->db->where('remitente', $current_user);
			 $this->db->or_where('receptor', $current_user);
			 $message_threads = $this->db->get('mensaje_thread')->result_array();
			 foreach ($message_threads as $row){
				$unread_message_number = $this->crud_model->count_unread_message_of_thread($row['mensaje_thread_code']); 
					...
					<div class="content">
						...
						<ul>
							...
							foreach ($message_threads as $row):
								...
								if ($row['remitente'] == $current_user)
									$user_to_show = explode('-', $row['receptor']);
								if ($row['reciever'] == $current_user)
									$user_to_show = explode('-', $row['remitente']);
							...
							<li>
								<a href="<?php echo base_url(); ?>index.php?<?php echo $loger_message; ?>/mensaje/mensaje_read/<?php echo $row['mensaje_thread_code']; ?>" class="clearfix">
						...
						<div class="text-right">
							<a href="<?php echo base_url(); ?>index.php?<?php echo $loger_message; ?>/mensaje" class="view-more">View All</a>
						</div>
					</div>
				</div>
			</li>
