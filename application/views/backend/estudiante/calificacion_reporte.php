<section class="panel">
<?php echo form_open(base_url() . 'index.php?admin/calificacion_reporte',array('id' => 'form'));?>
...
<div class="col-md-12 mb-sm">
	...
	<center>
		<a href="<?php echo base_url();?>index.php?admin/ver_imprimir_calificacion/<?php echo $clase_id;?>/<?php echo $examen_id;?>" 
