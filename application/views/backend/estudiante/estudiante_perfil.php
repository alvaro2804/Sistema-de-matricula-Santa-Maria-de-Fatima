		...
		<div class="tabs">
			...
			<div class="tab-content">
				...
				<div id="edit" class="tab-pane active">
					...
					<?php echo form_open(base_url() . 'index.php?estudiante/estudiante_perfil/actualizar_perfil_info' , array('class' => 'form-horizontal form-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
					...
					<fieldset class="mb-xl">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" class="form-control" required title="Ingrese Nombre (Obligatorio)" name="nombre" value="<?php echo $row['nombre'];?>"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" class="form-control" required title="Ingrese Email (Obligatorio)" name="email" value="<?php echo $row['email'];?>"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" class="form-control" required title="Ingrese Dirección (Obligatorio)" name="direccion" value="<?php echo $row['direccion'];?>"/>
							</div>
						</div>
					...
					<?php echo form_open(base_url() . 'index.php?estudiante/estudiante_perfil/cambiar_password' , array('class' => 'form-horizontal form-bordered validate','target'=>'_top'));?>
					<h4 class="mb-xlg">
