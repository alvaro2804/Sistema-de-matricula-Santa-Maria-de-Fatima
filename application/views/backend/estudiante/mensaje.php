							...
							<menu id="content-menu" class="inner-menu" role="menu">
								<div class="nano">
									<div class="nano-content">
										...
										<!-- redactar nuevo botón de correo electrónico -->
										<div class="inner-menu-content">
											<a href="<?php echo base_url(); ?>index.php?estudiante/mensaje/mensaje_nuevo" class="btn btn-block btn-primary btn-md pt-sm pb-sm text-md">
												<i class="fa fa-envelope mr-xs"></i>
												Nuevo Mensaje
											</a>
											
							
											<!-- Lista de la bandeja de entrada del usuario del mensaje -->							
											 <ul class="list-unstyled mt-xl pt-md">							
												...
												foreach ($mensaje_threads as $row):
													...
													// definir el usuario que se va a mostrar
													...
													?>
														...
														<li>
															<a href="<?php echo base_url(); ?>index.php?estudiante/mensaje/mensaje_leido/<?php echo $row['mensaje_thread_code']; ?>" class="menu-item <?php if (isset($actual_mensaje_thread_code) && $actual_mensaje_thread_code == $row['mensaje_thread_code']) echo 'active'; ?>">
																...
																<?php echo $usuario_para_mostrar_type; ?> </span>
