			...
			<div class="panel panel-sign">
				...
				<div class="panel-body">
					...
					<div class="text-center">
					 <div class="mb-xs"><img src="uploads/avatar.svg" height="54" alt="Baxter School" /></div>
					...
					<form method="post" id="login">
						...
						<div class="row">
							<div class="col-sm-12 text-right">
								<button type="submit" class="btn btn-primary hidden-xs"><i class="fa fa-sign-in mr-xs"></i> Ingresar</button>
								<button type="submit" class="btn btn-primary btn-block btn-lg visible-xs mt-lg"><i class="fa fa-sign-in mr-xs"></i> Ingresar</button>
							</div>
						</div>
					...
					$.ajax( {
						...
						success: function ( response ) {
							...
							if ( response.login_status == 'success' ) {
								...
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>\<strong>Inválido Login!</strong><br/>Ha ingresado un correo electrónico o contraseña incorrectos, intente nuevamente e ingrese el correo electrónico y la contraseña correctos.!\
								</div>' );
