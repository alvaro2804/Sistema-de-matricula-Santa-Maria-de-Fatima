        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box" id="add">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'index.php?admin/anuncio/create', array('class' => 'form-horizontal form-bordered validate', 'target' => '_top')); ?>
                    ...
                    <!--CODIGO PARA ENVIAR MEDIANTE SMS .  PERO EL SISTEMA AUN NO SE IMPLEMENTA(EN PROCESO) -->
                    <!--
                    <div class="form-group">
