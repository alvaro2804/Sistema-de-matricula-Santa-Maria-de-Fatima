<?php echo form_open(base_url() . 'index.php?admin/selector_calificacion',array('id' => 'form'));?>
<section class="panel">
  <div class="panel-body">
	...
	<div class="col-md-3 mb-sm">
		...
		<label class="control-label">Clase <span class="required">*</span></label>
			<select name="clase_id" class="form-control" onchange="get_class_subject(this.value)" data-plugin-selectTwo required title="Valor Requerido" data-width="100%" data-minimum-results-for-search="Infinity">
...
<script type="text/javascript">
	function get_class_subject(clase_id) {
