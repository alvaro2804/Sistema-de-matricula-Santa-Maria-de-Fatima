		...
		<div class="row">
			...
			<div class="col-md-3 mb-sm">
				<div class="form-group">
					...
					<select name="clase_id" class="form-control" data-plugin-selectTwo required title="Valor Requerido" data-width="100%" data-minimum-results-for-search="Infinity" onchange="get_class_subject(this.value)">
						<option value="">
							Seleccionar Clase
						</option>
						<?php
