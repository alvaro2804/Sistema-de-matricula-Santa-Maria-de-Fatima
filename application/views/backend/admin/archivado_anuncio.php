		...
		foreach ($anuncios as $row):
			...
			<tr>
				...
				<td>
					...
					<!-- ARCHIVAR ANUNCIO -->
					<a href="<?php echo base_url() ?>index.php?admin/anuncio/eliminar_de_archivo/<?php echo $row['anuncio_id'] ?>" class="btn btn-primary btn-xs" data-placement="top" data-toggle="tooltip" data-original-title="Archivar Anunicio" >
