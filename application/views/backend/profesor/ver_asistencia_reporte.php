<?php echo form_open(base_url() . 'index.php?profesor/asistencia_reporte_seleccionador/' , array('id' => 'form')); ?>
<section class="panel">
	...
	<div class="panel-footer">
		<center>
			<a href="<?php echo base_url(); ?>index.php?profesor/ver_asistencia_reporte_imprimir/<?php echo $clase_id; ?>/<?php echo $seccion_id; ?>/<?php echo $month; ?>" class="btn btn-sm btn-primary " target="_blank">
