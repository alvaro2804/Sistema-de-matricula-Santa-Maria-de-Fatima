				...
				<div class="tabs tabs-success">
					...
					<ul class="nav nav-tabs text-right">
						...
						<li class="<?php if ($row['clase_id'] == $clase_id) echo 'active';?>">
							<a href="<?php echo base_url();?>index.php?profesor/plan_estudio/<?php echo $row['clase_id'];?>">
									...
									<tbody>
										...
										<tr>
											...
											<td align="center" width="100">
												...
												<!-- SYLLABUS DESCARGAR -->
												<a class="btn btn-primary btn-xs" data-placement="top" data-toggle="tooltip" data-original-title="Descargar" href="<?php echo base_url();?>index.php?profesor/descargar_plan_estudio/<?php echo $row['plan_estudio_cod'];?>">
										            <i class="fa fa-download"></i>
									            </a>
									            
												<!--ELIMINAR -->
												<a href="#" class="btn btn-danger btn-xs" data-placement="top" data-toggle="tooltip" data-original-title="Borrar" onclick="confirm_modal('<?php echo base_url();?>index.php?profesor/plan_estudio_eliminar/<?php echo $row['plan_estudio_cod'].'/'.$row['clase_id'] ;?>');">
