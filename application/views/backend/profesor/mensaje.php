								...
								<div class="nano">
									<div class="nano-content">
										...
										<div class="inner-menu-content">
											<a href="<?php echo base_url(); ?>index.php?profesor/mensaje/mensaje_nuevo" class="btn btn-block btn-primary btn-md pt-sm pb-sm text-md">
											 ...
											 <ul class="list-unstyled mt-xl pt-md">							
												...
												foreach ($mensaje_threads as $row):
													...
													?>
														...
														<li>
															<a href="<?php echo base_url(); ?>index.php?profesor/mensaje/mensaje_leido/<?php echo $row['mensaje_thread_code']; ?>" class="menu-item <?php if (isset($actual_mensaje_thread_code) && $actual_mensaje_thread_code == $row['mensaje_thread_code']) echo 'active'; ?>">
																...
																<?php echo $this->db->get_where($usuario_para_mostrar_type, array($usuario_para_mostrar_type . '_id' => $usuario_para_mostrar_id))->row()->name; ?>
