<?php echo form_open(base_url() . 'index.php?profesor/selector_calificacion');?>
<section class="panel">
	<div class="panel-body">
		...
		<div class="row">
			...
			<div class="col-md-12 mb-sm">
				...
				<?php echo form_open(base_url() . 'index.php?profesor/actualizar_calificacion/'.$examen_id.'/'.$clase_id.'/'.$seccion_id.'/'.$tema_id);?>
