    ...
    foreach ($anuncios as $row):
        ...
        <tr>
            ...
            <td width="120">
					...
					<!-- ARCHIVAR ANUNCIO -->
					<a href="<?php echo base_url() ?>index.php?profesor/anuncio/archivar_anuncio/<?php echo $row['anuncio_id'] ?>" class="btn btn-primary btn-xs" data-placement="top" data-toggle="tooltip" data-original-title="Archivar Anunicio" >
