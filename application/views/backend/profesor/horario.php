			...
			<div class="col-md-12">
				<div class="panel panel-border panel-primary">
					<header class="panel-heading">
						<a href="<?php echo base_url();?>index.php?profesor/horario_imprimir/<?php echo $clase_id;?>/<?php echo $row['seccion_id'];?>" class="btn btn-danger btn-xs pull-right" target="_blank">
...
<script type="text/javascript">
	function class_section( clase_id ) {
		window.location.href = '<?php echo base_url(); ?>index.php?profesor/horario/' + clase_id;
	}
</script>