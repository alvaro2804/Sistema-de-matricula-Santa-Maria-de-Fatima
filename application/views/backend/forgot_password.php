		...
		<div class="center-sign">
			...
			<div class="panel panel-sign">
				<div class="panel-title-sign mt-xl text-right">
					<h2 class="title text-uppercase text-weight-bold m-none"><i class="fa fa-user mr-xs"></i> Recuperar Contraseña</h2>
				</div>
				<div class="panel-body">
					...
					<div class="alert alert-info">
						<p class="m-none text-weight-semibold h6">¡Ingrese su correo electrónico a continuación y le enviaremos instrucciones de reinicio!</p>
					</div>
					...
					<form method="post" id="login" class="validate">
						...
						<div class="text-center mt-lg"> 
							<a href="<?php echo base_url(); ?>index.php?login"> <i class="fa fa-long-arrow-left mr-xs"></i>¿Volver a la página de inicio de sesión? 
							</a>
						</div>
					</form>
				</div>
